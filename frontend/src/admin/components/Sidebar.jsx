        ...
        <>
            ...
            <div className=' h-[calc(100vh-3.56rem)]  border-r-gray-950 p-3'>
                <ul className='font-[heading2] tracking-wide '>
                    ...
                    <li><Link to={"/admin/manageusers"} className={`flex gap-2 items-center p-2  hover:bg-gray-200 ease-in duration-300 rounded ${pathname=="/admin/allusers" && "bg-gray-400 hover:bg-gray-400"  } `} onClick={MobSidebarTogglerFunc}><img src="/images/clarity--employee-group-line.svg" className='w-5 h-5' /><p>Manage Users</p></Link></li>

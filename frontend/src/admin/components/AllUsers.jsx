...
const AllUsers = () => {
  ...
  return (
    <>
        <div className=''>
        <p className='font-[heading2] text-xl bg-gray-400 p-2 rounded text-shadow-sm'>All Users</p>
      </div>
      ...
      <div  className='mt-3 grid grid-cols-4 gap-3 '>
        {
            UsersList.map((data,index)=>{
                return (<>
                    <div className='bg-gray-500 rounded p-3 flex flex-col gap-3'>
                  ...
                  timeStyle: "short",
                    ...
                    <div className='flex justify-end'>
                        <Link to={`/admin/edituser/${data.email}`} className='p-1 cursor-pointer border-1 rounded'>Edit Details</Link>
                    </div>
        </div>
                </>)
            })

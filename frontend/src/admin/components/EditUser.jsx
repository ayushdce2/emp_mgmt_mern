...
const EditUser = () => {
  ...
  return (<>
    ...
    <form onSubmit={updateUserData} className='flex flex-col gap-2 md:w-[30rem] border-1 border-gray-400 mt-3 p-3 rounded'>
        <div className='flex gap-3 items-center my-5'>
            <label className='text-lg text-gray-500 w-[4rem]'>Name : </label>
        ...
        <div className='flex gap-3 items-center mb-5 '>
            <label className='text-lg text-gray-500 w-[4rem]'>Email : </label>
        ...
        <div className='flex gap-3 items-center mb-5'>
            <label className='text-lg text-gray-500 w-[4rem]'>Role : </label>

                ...
                <div className={` h-full w-full `}>
                    ...
                    <div className=''>
                        <div className='flex ml-auto p-3 justify-between md:justify-end gap-4 items-center'>
                            ...
                            <Link to={"/hr/announcement"} className=' hidden w-6 h-6 md:flex items-center justify-center  overflow-hidden'>
                            ...
                            <Link to={"/hr/messaging"} className=' hidden w-6 h-6 md:flex items-center justify-center overflow-hidden'>
                            ...
                            <div>
                                <p className='bg-gray-200 p-1 px-2 font-[heading2] rounded hidden md:inline-block'>Hr</p>
                            </div>

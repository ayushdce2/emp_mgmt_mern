                        ...
                        return (<>
                            <div className='hover:bg-gray-400 ease-in duration-200 bg-gray-300 rounded p-3 flex flex-col gap-3  '>
                                ...
                                <div className='flex justify-end '>
                                    <Link to={`/hr/edituser/${data.email}`} className='hover:bg-gray-500 hover:text-gray-200 p-1 cursor-pointer border-1 border-gray-500 rounded text-gray-800'>Edit Details</Link>
                                </div>
                            </div>
                        </>)
                    })

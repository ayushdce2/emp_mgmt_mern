    ...
    <>
        ...
        <div className='ml-[1vw] md:ml-[20vw] shadow-[rgba(0,0,0,0.24)_0px_3px_8px] flex flex-col w-[95%] md:w-[30%] p-7 rounded'>
            ...
            <form onSubmit={loginSubmit} className='flex flex-col'>
              <input type='text' placeholder='email' name="email" value="ayush@aps.com" onChange={loginFormData} className='text-lg mb-5 h-10 p-2 outline-0 border-b-2 text-[#71b1e5] border-b-[#71b1e5]'/>
              <input type='text' placeholder='password' name="password" value="ayush" onChange={loginFormData} className='text-lg mb-10 h-10 p-2 outline-0 border-b-2 text-[#71b1e5] border-b-[#71b1e5]'/>
